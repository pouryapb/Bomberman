...
public class OnlinePlayer extends GameObject {

	private int width = 32, height = 32;

	public enum ONLINEID {
		Player1, Player2
	}
	...
	public OnlinePlayer(int x, int y, ID id, ONLINEID onlineId, Handler handler, HUD hud, Game game) {
		super(x, y, id);
